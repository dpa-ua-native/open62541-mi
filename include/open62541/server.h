...
# endif
    ...
    void (*monitoredItemRegisterCallback)(UA_Server *server, const UA_NodeId *sessionId,
                                          void *sessionContext, UA_UInt32 subscriptionId,
                                          UA_UInt32 monitoredItemId,
                                          UA_MonitoringMode monitoringMode,
                                          UA_Double samplingInterval,
                                          const UA_NodeId *nodeId, void *nodeContext,
                                          UA_NumericRange *range, UA_UInt32 attibuteId);
    void (*monitoredItemUnregisterCallback)(UA_Server *server, const UA_NodeId *sessionId,
                                            void *sessionContext,
                                            UA_UInt32 subscriptionId,
                                            UA_UInt32 monitoredItemId,
                                            const UA_NodeId *nodeId, void *nodeContext,
                                            UA_NumericRange *range, UA_UInt32 attibuteId);
    void (*monitoredItemChangeCallback)(UA_Server *server, const UA_NodeId *sessionId,
                                        void *sessionContext, UA_UInt32 subscriptionId,
                                        UA_UInt32 monitoredItemId,
                                        UA_MonitoringMode monitoringMode,
                                        UA_Double samplingInterval,
